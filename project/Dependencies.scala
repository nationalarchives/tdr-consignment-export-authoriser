...
object Dependencies {
  lazy val generatedGraphql = "uk.gov.nationalarchives" %% "tdr-generated-graphql" % "0.0.379"
  lazy val kmsUtils =  "uk.gov.nationalarchives" %% "kms-utils" % "0.1.197"
  lazy val catsEffect = "org.typelevel" %% "cats-effect" % "3.5.4"
  lazy val graphqlClient = "uk.gov.nationalarchives" %% "tdr-graphql-client" % "0.0.171"
