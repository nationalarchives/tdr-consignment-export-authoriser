...
object Dependencies {
  ...
  lazy val kmsUtils =  "uk.gov.nationalarchives" %% "kms-utils" % "0.1.113"
  lazy val catsEffect = "org.typelevel" %% "cats-effect" % "3.5.2"
  lazy val graphqlClient = "uk.gov.nationalarchives" %% "tdr-graphql-client" % "0.0.137"
  lazy val log4cats = "org.typelevel" %% "log4cats-core"    % "2.6.0"
  lazy val log4catsSlf4j = "org.typelevel" %% "log4cats-slf4j"   % "2.6.0"
  lazy val mockitoScala = "org.mockito" %% "mockito-scala" % "1.17.29"
  lazy val mockitoScalaTest = "org.mockito" %% "mockito-scala-scalatest" % "1.17.29"
