...
object Dependencies {
  ...
  lazy val kmsUtils =  "uk.gov.nationalarchives" %% "kms-utils" % "0.1.101"
  lazy val catsEffect = "org.typelevel" %% "cats-effect" % "3.5.1"
  lazy val graphqlClient = "uk.gov.nationalarchives" %% "tdr-graphql-client" % "0.0.126"
  ...
  lazy val mockitoScalaTest = "org.mockito" %% "mockito-scala-scalatest" % "1.17.22"
