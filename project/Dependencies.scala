...
object Dependencies {
  lazy val generatedGraphql = "uk.gov.nationalarchives" %% "tdr-generated-graphql" % "0.0.327"
  lazy val kmsUtils =  "uk.gov.nationalarchives" %% "kms-utils" % "0.1.89"
  lazy val catsEffect = "org.typelevel" %% "cats-effect" % "3.5.0"
  lazy val graphqlClient = "uk.gov.nationalarchives" %% "tdr-graphql-client" % "0.0.107"
  lazy val log4cats = "org.typelevel" %% "log4cats-core"    % "2.6.0"
  lazy val log4catsSlf4j = "org.typelevel" %% "log4cats-slf4j"   % "2.6.0"
  lazy val mockitoScala = "org.mockito" %% "mockito-scala" % "1.17.14"
  lazy val mockitoScalaTest = "org.mockito" %% "mockito-scala-scalatest" % "1.17.14"
