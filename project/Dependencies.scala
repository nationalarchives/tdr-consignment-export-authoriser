...
object Dependencies {
  lazy val generatedGraphql = "uk.gov.nationalarchives" %% "tdr-generated-graphql" % "0.0.330"
  lazy val kmsUtils =  "uk.gov.nationalarchives" %% "kms-utils" % "0.1.92"
  lazy val catsEffect = "org.typelevel" %% "cats-effect" % "3.5.0"
  lazy val graphqlClient = "uk.gov.nationalarchives" %% "tdr-graphql-client" % "0.0.109"
