...
object Dependencies {
  lazy val kmsUtils =  "uk.gov.nationalarchives" %% "kms-utils" % "0.1.268"
  ...
  lazy val mockitoScala = "org.mockito" %% "mockito-scala" % "1.17.45"
  lazy val mockitoScalaTest = "org.mockito" %% "mockito-scala-scalatest" % "1.17.45"
